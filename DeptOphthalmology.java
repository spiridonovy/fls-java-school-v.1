...
public class DeptOphthalmology extends DeptClinic {
    private int amountEmployees;
    private List<EmployeeClinic> employees;
    private EmployeeClinic departmentHead;
    public DeptOphthalmology(int amountEmployees, List<EmployeeClinic> employees, EmployeeClinic departmentHead){
    ...
    public void printDepartment(){
        ...
        System.out.println("Name Ophthalmology department head: " + departmentHead);
    }
}
