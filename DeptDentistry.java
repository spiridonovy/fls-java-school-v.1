...
public class DeptDentistry extends DeptClinic {
    private int amountEmployees;
    private List<EmployeeClinic> employees;
    private EmployeeClinic departmentHead;
    public DeptDentistry(int amountEmployees, List<EmployeeClinic> employees, EmployeeClinic departmentHead){
    ...
    public void printDepartment(){
        System.out.println("##############################################");
        System.out.println("Dentistry Department");
        for (int i = 0; i < amountEmployees - 1; i++){
            System.out.println(employees.get(i));
        }
        System.out.println("Name Dentistry department head: " + departmentHead);
    }
}
