...
public class DeptDermatology extends DeptClinic {
    private int amountEmployees;
    private List<EmployeeClinic> employees;
    private EmployeeClinic departmentHead;
    public DeptDermatology(int amountEmployees, List<EmployeeClinic> employees, EmployeeClinic departmentHead){
    ...
    public void printDepartment(){
        ...
        System.out.println("Name Dermatology department head: " + departmentHead);
    }
}
